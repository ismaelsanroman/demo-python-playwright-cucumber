...
def step_send_login_request_step(context):
...
def step_send_items_request_step(context):
...
def step_verify_items_request_step(context):
...
def step_send_creation_request_step(context):
...
def step_confirm_creation_step(context):
...
def step_delete_created_items_step(context):
...
def step_confirm_deletion_step(context):
...
def step_verify_failed_creation_step(context):
...
def step_item_already_exists_step(context, item_id):
...
def step_verify_duplicate_creation_step(context):
...
def step_get_item_by_id_step(context, item_id):
...
def step_verify_item_not_found_step(context):
...
def step_send_items_request_no_token_step(context):
...
def step_verify_missing_token_error_step(context):
