...
def step_click_radiobutton_step(context, radiobtn_name: str):
...
def step_radiobutton_verify_step(context, radiobtn_name: str):
...
def step_radiobutton_disabled_step(context, radiobtn_name: str):
...
def step_radiobutton_notSelected_step(context, radiobtn_name: str):
