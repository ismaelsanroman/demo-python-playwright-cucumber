...
def step_select_checkbox_for_step(context, checkbox_name):
...
def step_labels_selected_step(context, state: str):
...
def step_deselect_checkbox_for_step(context, checkbox_name):
...
def expand_section_button_step(context, section: str):
